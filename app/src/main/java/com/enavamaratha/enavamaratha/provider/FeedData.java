...
public class FeedData {
    ...
    public static final String AUTHORITY = "com.enavamaratha.enavamaratha.provider.FeedData";
    ...
    public static class EntryColumns implements BaseColumns {
        ...
        public static final String[][] COLUMNS = new String[][]{{_ID, TYPE_PRIMARY_KEY}, {FEED_ID, TYPE_EXTERNAL_ID}, {TITLE, TYPE_TEXT},
                ...
                {IS_FAVORITE, TYPE_BOOLEAN}, {ENCLOSURE, TYPE_TEXT}, {GUID, TYPE_TEXT}, {AUTHOR, TYPE_TEXT}, {IMAGE_URL, TYPE_TEXT},{FLAG,TYPE_TEXT}};
