...
package com.enavamaratha.enavamaratha.widget;
...
import com.enavamaratha.enavamaratha.utils.ThrottledContentObserver;
...
class WidgetFeedsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        if (mCursor.moveToPosition(position)) {
            ...
            row.setImageViewResource(android.R.id.icon,R.drawable.llogo);
            if (!mCursor.isNull(2)) {
                try {
